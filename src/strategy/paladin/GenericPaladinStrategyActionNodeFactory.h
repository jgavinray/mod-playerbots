...
private:
    static ActionNode* blessing_of_sanctuary([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* blessing_of_kings([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* blessing_of_wisdom([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* blessing_of_kings_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* blessing_of_wisdom_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* retribution_aura([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* lay_on_hands([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* lay_on_hands_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    // static ActionNode* seal_of_light([[maybe_unused]] PlayerbotAI* ai)
    // {
    ...
    //         /*C*/ NULL);
    // }
    static ActionNode* cleanse_poison([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* cleanse_magic([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* cleanse_disease([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* cleanse_poison_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* cleanse_disease_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    // static ActionNode* seal_of_wisdom([[maybe_unused]] PlayerbotAI* ai)
    // {
    ...
    //         /*C*/ NULL);
    // }
    static ActionNode* seal_of_justice([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* hand_of_reckoning([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* righteous_defense([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* avengers_shield([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* divine_sacrifice([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* judgement_of_wisdom([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* judgement([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* divine_shield([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* flash_of_light([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* flash_of_light_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* holy_wrath([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* hammer_of_wrath([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* seal_of_command([[maybe_unused]] PlayerbotAI* ai)
    {
