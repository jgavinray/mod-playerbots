...
bool ReviveFromCorpseAction::Execute([[maybe_unused]] Event event)
{
...
bool FindCorpseAction::Execute([[maybe_unused]] Event event)
{
...
bool SpiritHealerAction::Execute([[maybe_unused]] Event event)
{
    Corpse* corpse = bot->GetCorpse();
    if (!corpse)
    {
