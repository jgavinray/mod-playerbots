...
bool RpgSubAction::Execute([[maybe_unused]] Event event)
{
...
Event RpgSubAction::ActionEvent([[maybe_unused]] Event event) { return event; }

bool RpgStayAction::isUseful() { return rpg->InRange() && !botAI->HasRealPlayerMaster(); }

bool RpgStayAction::Execute([[maybe_unused]] Event event)
{
...
bool RpgWorkAction::Execute([[maybe_unused]] Event event)
{
...
bool RpgEmoteAction::Execute([[maybe_unused]] Event event)
{
...
bool RpgCancelAction::Execute([[maybe_unused]] Event event)
{
...
bool RpgTaxiAction::Execute([[maybe_unused]] Event event)
{
...
bool RpgDiscoverAction::Execute([[maybe_unused]] Event event)
{
    GuidPosition guidP = rpg->guidP();
...
bool RpgHealAction::Execute([[maybe_unused]] Event event)
{
    bool retVal = false;
...
bool RpgTradeUsefulAction::Execute([[maybe_unused]] Event event)
{
...
bool RpgDuelAction::Execute([[maybe_unused]] Event event)
{
    GuidPosition guidP = AI_VALUE(GuidPosition, "rpg target");
...
bool RpgMountAnimAction::Execute([[maybe_unused]] Event event)
{
    WorldPacket p;
