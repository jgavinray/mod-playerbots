...
private:
    static ActionNode* inner_fire([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* holy_nova([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* power_word_fortitude([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* power_word_fortitude_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* divine_spirit([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* divine_spirit_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* power_word_shield([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* power_word_shield_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* renew([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* renew_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* greater_heal([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* greater_heal_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* heal([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* heal_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* lesser_heal([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* lesser_heal_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* flash_heal([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* flash_heal_on_party([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    static ActionNode* psychic_scream([[maybe_unused]] PlayerbotAI* ai)
    {
    ...
    // static ActionNode* fade([[maybe_unused]] PlayerbotAI* ai)
    // {
    ...
    //         /*C*/ NULL);
    // }
    static ActionNode* shadowfiend([[maybe_unused]] PlayerbotAI* ai)
    {
