...
bool BroadcastHelper::BroadcastTest(PlayerbotAI* ai, [[maybe_unused]] Player* bot)
{
...
bool BroadcastHelper::BroadcastGuildMemberPromotion(PlayerbotAI* ai, [[maybe_unused]] Player* bot, Player* player)
{
    if (!sPlayerbotAIConfig->enableBroadcasts)
        return false;
...
bool BroadcastHelper::BroadcastGuildMemberDemotion(PlayerbotAI* ai, [[maybe_unused]] Player* bot, Player* player)
{
    if (urand(1, sPlayerbotAIConfig->broadcastChanceMaxValue) <= sPlayerbotAIConfig->broadcastChanceGuildManagement)
    {
        std::map<std::string, std::string> placeholders;
...
bool BroadcastHelper::BroadcastGuildGroupOrRaidInvite(PlayerbotAI* ai, [[maybe_unused]] Player* bot, Player* player, Group* group)
{
    if (!sPlayerbotAIConfig->enableBroadcasts)
        return false;
    std::map<std::string, std::string> placeholders;
